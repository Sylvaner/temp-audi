/**
 * Helper pour générer des icônes Font Awesome SVG pour les marqueurs Leaflet (Editor)
 */
 ...
 */
export function getFontAwesomeSVG(iconName) {
  ...
  try {
    ...
    const faIcon = icon({ prefix: 'fas', iconName: cleanIconName })
